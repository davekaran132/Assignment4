<?php
    ...
    $file = file_get_contents('./students.csv');
    $lines = explode("\n", $file);
echo '
<html>
<head>
...
<body>
    ...
    <div class="form-container">
        ...
        <form>
            ...
            <label>Course Number:
                <select id="course_number" name="course_number">
                    <option value="1">CNET 2020</option>
                    <option value="2">CNET 2021</option>
                    <option value="3">CNET 2022</option>
                </select>
            </label>
     ...
     <table>
        ...
        // Loop through each line of the file and add a row to the table
